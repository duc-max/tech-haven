...
function About() {
  return (
    <>
      <Container>
        <section className={clsx(style.mtSection)}>
            ...
            <div className={style.aboutData}>
              <div>
                ...
                <p style={{ marginBottom: "10px" }}>
                  From humble beginnings to where we are today, our commitment
                  to innovation has remained unwavering. We've overcome
                  challenges, embraced opportunities, and evolved with the
                  rapidly changing tech landscape.
                </p>
                <p>
                  Our story is one of passion, innovation, and relentless
                  pursuit of excellence. It all began with a shared vision to
